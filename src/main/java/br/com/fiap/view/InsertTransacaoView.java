...
public class InsertTransacaoView {
    public static void main(String[] args) {
        try {
            ...
            Despesa despesa = new Despesa("Supermercado", "Compras", 250.00, categoria, usuarioId, contaId);
            transacaoDAO.insert(despesa);
            
            // Clean up - delete transacao first, then conta
            transacaoDAO.delete(despesa.getId());
